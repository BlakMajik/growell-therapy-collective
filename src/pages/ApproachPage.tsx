...
export const ApproachPage: React.FC = () => {
  return (
    <div className="approach-page">
      <SEOHead
        title="Our Approach | Whole-Person & Integrative Philosophy"
        description="Discover how GroWell Therapy Collective integrates evidence-based clinical psychotherapy with complementary experiential wellness to support the whole person."
          ...
          <div className="grid-2 align-center">
            <div className="ecosystem-text">
              ...
              <div className="intersect-tags-grid">
                ...
                <span className="intersect-tag">Learning & Neurodivergence</span>
      ...
      <section className="section section-bg-sage" aria-labelledby="framework-heading">
        <div className="container">
          ...
          <div className="grid-2 pillars-framework-grid">
            ...
            <div className="card framework-pillar-card">
              ...
              <h3 className="pillar-header-title">Evidence-Based & Clinical Approaches</h3>
              ...
              <div className="framework-items-stack">
                <div className="framework-item">
                  ...
                  <p>Certified trauma psychotherapy using bilateral stimulation to facilitate neural memory reprocessing.</p>
                </div>
                <div className="framework-item">
                  <h4>Trauma-Focused Cognitive Behavioral Therapy (TF-CBT)</h4>
                  <p>Structured, research-backed model empowering youth and caregivers to process trauma and build emotional regulation.</p>
                </div>
                <div className="framework-item">
                ...
                <div className="framework-item">
                  ...
                  <p>Humanistic collaboration fostering psychological safety, self-trust, and internal empowerment.</p>
                </div>
              </div>
            </div>
            ...
            <div className="card framework-pillar-card">
              ...
              <p className="pillar-header-sub">
                Optional sensory and creative modalities integrated collaboratively when appropriate.
              </p>
      ...
      <ConsultationCTA
        ...
        subtitle="Book a consultation to talk with Jessica Mouzon about your goals and design a collaborative path toward growth."
      />
