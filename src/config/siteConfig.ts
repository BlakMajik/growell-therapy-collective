...
export const siteConfig: SiteConfig = {
  ...
  credentials: {
    ...
    gottmanTraining: "Gottman Level 1 Trained",
  ...
  modalities: {
    clinical: [
      ...
      },
      {
        ...
        fullDesc: "Jessica is Gottman Level 1 Trained in Gottman Method Couples Therapy, providing evidence-informed frameworks for understanding relationship dynamics, communication patterns, emotional connection, and conflict patterns.",
        isEvidenceBased: true,
      },
    ],
    complementary: [
